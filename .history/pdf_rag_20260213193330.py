...
def main():
    ...
    if OLLAMA_AVAILABLE:
        ...
        print("Running in Basic Search mode")
        print("(Install langchain-ollama for AI answers)")
        mode = "1"
    ...
    while True:
        ...
        if question.lower() == "switch" and OLLAMA_AVAILABLE:
        ...
        if mode == "2" and OLLAMA_AVAILABLE:
